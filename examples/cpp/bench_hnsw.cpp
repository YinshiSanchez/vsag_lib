...
main() {
    ...
    auto data =
        load_fvecs("/home/yinshi/dataset/siftsmall/siftsmall_base.fvecs", dim, max_elements);
    ...
    uint32_t query_num;
    auto queries =
        load_fvecs("/home/yinshi/dataset/siftsmall/siftsmall_query.fvecs", dim, query_num);
